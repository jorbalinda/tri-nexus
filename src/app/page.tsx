    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <p className="text-xs font-bold uppercase tracking-[3px] text-[#4361ee]">RACE DAY</p>
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/auth/signup"
              className="px-5 py-2 rounded-xl bg-primary text-white text-sm font-semibold hover:bg-primary-hover transition-all"
            >
              Get Started Free
            </Link>
          </div>
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="flex items-center justify-center gap-4 mb-6">
              <div className="flex items-center gap-1.5 text-[#219ebc]">
                <Waves size={16} />
                <span className="text-[11px] font-bold uppercase tracking-[2px]">Swim</span>
              </div>
              <div className="w-px h-3 bg-gray-300 dark:bg-gray-600" />
              <div className="flex items-center gap-1.5 text-[#fb8500]">
                <Bike size={16} />
                <span className="text-[11px] font-bold uppercase tracking-[2px]">Bike</span>
              </div>
              <div className="w-px h-3 bg-gray-300 dark:bg-gray-600" />
              <div className="flex items-center gap-1.5 text-[#4cc9a0]">
                <Footprints size={16} />
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-gray-100 leading-tight mb-6">
              ...
              <span className="text-[#4361ee]">Before the Race Starts.</span>
            </h1>
            ...
            <Link
              href="/auth/signup"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-primary text-white text-sm font-semibold hover:bg-primary-hover active:scale-[0.98] transition-all"
            >
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="card-squircle p-6 text-center">
                <div className="w-12 h-12 rounded-2xl bg-[#4361ee]/10 dark:bg-[#4361ee]/15 flex items-center justify-center mx-auto mb-4">
                  <TrendingUp size={24} className="text-[#4361ee]" />
                </div>
              ...
              <div className="card-squircle p-6 text-center">
                <div className="w-12 h-12 rounded-2xl bg-[#fb8500]/10 dark:bg-[#fb8500]/15 flex items-center justify-center mx-auto mb-4">
                  <Timer size={24} className="text-[#fb8500]" />
                </div>
              ...
              <div className="card-squircle p-6 text-center">
                <div className="w-12 h-12 rounded-2xl bg-[#4cc9a0]/10 dark:bg-[#4cc9a0]/15 flex items-center justify-center mx-auto mb-4">
                  <Target size={24} className="text-[#4cc9a0]" />
                </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[11px] font-bold uppercase tracking-[3px] text-[#4361ee] mb-3">Features</p>
            ...
            {[
              {
                ...
                color: 'text-[#4361ee]',
                bg: 'bg-[#4361ee]/10 dark:bg-[#4361ee]/15',
              },
              {
                icon: TrendingUp,
                ...
                color: 'text-[#2a9d8f]',
                bg: 'bg-[#2a9d8f]/10 dark:bg-[#2a9d8f]/15',
              },
              {
                icon: Timer,
                title: 'Race Day Plan',
                ...
                color: 'text-[#fb8500]',
                bg: 'bg-[#fb8500]/10 dark:bg-[#fb8500]/15',
              },
              {
                icon: Waves,
                title: 'Device Sync*',
                ...
                color: 'text-[#219ebc]',
                bg: 'bg-[#219ebc]/10 dark:bg-[#219ebc]/15',
              },
              {
                icon: Target,
                ...
                color: 'text-[#e2622c]',
                bg: 'bg-[#e2622c]/10 dark:bg-[#e2622c]/15',
              },
              {
                icon: Bike,
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[11px] font-bold uppercase tracking-[3px] text-[#4361ee] mb-3">Pricing</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-100">
          ...
          <div className="max-w-md mx-auto">
            <div className="card-squircle p-8 ring-2 ring-[#4361ee] relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-primary text-white text-[11px] font-bold uppercase tracking-wider">
                Free for the first 500 users
              </div>
              <p className="text-[11px] font-bold uppercase tracking-[2px] text-[#4361ee] mb-2">Early Access</p>
              ...
              <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-300 mb-8">
                <li className="flex items-center gap-2"><span className="text-[#4cc9a0]">&#10003;</span> Unlimited races</li>
                <li className="flex items-center gap-2"><span className="text-[#4cc9a0]">&#10003;</span> Garmin sync (Coming Soon)</li>
                <li className="flex items-center gap-2"><span className="text-[#4cc9a0]">&#10003;</span> Dashboard & fitness trends</li>
                <li className="flex items-center gap-2"><span className="text-[#4cc9a0]">&#10003;</span> Projection progress indicator</li>
                <li className="flex items-center gap-2"><span className="text-[#4cc9a0]">&#10003;</span> Race week finish time reveal</li>
                <li className="flex items-center gap-2"><span className="text-[#4cc9a0]">&#10003;</span> Full race day plan</li>
              </ul>
              <Link
                href="/auth/signup"
                className="block text-center py-2.5 rounded-xl bg-primary text-white text-sm font-semibold hover:bg-primary-hover active:scale-[0.98] transition-all"
              >
                Get Started Free
              </Link>
            </div>
      ...
      <style jsx>{`
        .hero-gradient {
          background: linear-gradient(135deg, #05123e, #0f4da9, #4361ee, #219ebc, #2a9d8f, #4cc9a0);
