  ...
  return (
    <div className="card-squircle p-4 sm:p-6">
      <div className="flex items-center justify-between mb-3">
        ...
        {allGatesPassed && (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[#4cc9a0]/10 text-[#4cc9a0] text-[10px] font-bold">
      ...
      <div className="grid grid-cols-3 gap-2 mb-4">
        {sufficiency.gates.map((gate) => (
          ...
          >
            ...
            {gate.hasThreshold ? (
              <p className="text-[11px] text-[#4cc9a0] mt-0.5">
                Threshold set
              </p>
            ) : gate.passed ? (
              ...
              <div
                ...
                className={`flex items-start gap-2.5 p-2.5 rounded-xl ${
                  tier >= 2
                    ...
                    : 'bg-[#4361ee]/5 border border-[#4361ee]/15'
                }`}
              >
                {tier >= 2 ? (
                  <Lightbulb size={12} className="text-[#ffb703] shrink-0 mt-0.5" />
                ) : (
                ...
                <div>
                  ...
                  <p className={`text-[10px] ${tier >= 2 ? 'text-gray-400 dark:text-gray-500' : 'text-[#57a2ea]/80'}`}>
                    {action.impact}
                  </p>
                </div>
              </div>
